...
{
	  if(flagctrl.Bits.ScanTimeFlag)		//10或者100ms扫描一次[10ms mode1;100ms mode2]
		{
...
{		
	...
	if(ControllerInfo.NowGear==0x30)											//KD键  00110000
	{
...
void IOControl_Init(void)
{
  ...
  //档位采集信号IO(6路)
	...
	//************************************
	//电磁阀控制信号IO(5路)
	//1.时钟使能 2.管脚 3.速度 4.模式[推挽输出] 5.端口
...
编写时间：2017.01.20
编 写 人：FangYIkaii
注    意：1.KD键使能：前进挡--倒车灯0，空挡启动连锁0，电磁阀[制动/无制动]
											空挡--倒车灯0，空挡启动连锁1，电磁阀[制动/无制动]
											前进挡--倒车灯1，空挡启动连锁0，电磁阀
				2.KD键不使能：前进挡--倒车灯0，空挡启动连锁0，电磁阀[空挡，1档:制动/无制动，2档:制动/无制动，3挡，4挡]
										  空挡--倒车灯0，空挡启动连锁1，电磁阀[空挡，1档:制动/无制动，2档:制动/无制动，3挡，4挡]
										  前进挡--倒车灯1，空挡启动连锁0，电磁阀[空挡，1档，2档，3挡，4挡]
***********************************************************************/
