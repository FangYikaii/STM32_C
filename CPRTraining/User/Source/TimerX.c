...
//	flagTIM5.Bits.T1msec_Flag=TRUE;
//	if(flagTIM5.Bits.T1msec_Flag)							//1ms定时中断
//	{
//		flagTIM5.Bits.T1msec_Flag=FALSE;
//		FrqTimCout++;														//输出频率计数
//		if(FrqTimCout<(1000/2/Freq_Output))
//		{
//			Btn_Start_OUT(0);  
//		}
//		else if(FrqTimCout<(1000/Freq_Output))
//		{
//			Btn_Start_OUT(1);
//		}			
//		else
...
// 	PULSEGeneration(Timer5.msecond%2);
	...
	if(Timer5.msecond%200==0)									//100ms中断一次
	{
