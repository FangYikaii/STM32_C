...
#define     	RS485_COM2_EnPIN											GPIO_Pin_3
#define     	RS485_COM2_EnGPIOX										GPIOD	
#define     	RS485_COM2_RCC_APB2Periph_EnGPIOX			RCC_APB2Periph_GPIOD

#define     	RS485_COM5_EnPIN											GPIO_Pin_4
#define     	RS485_COM5_EnGPIOX										GPIOD	
#define     	RS485_COM5_RCC_APB2Periph_EnGPIOX			RCC_APB2Periph_GPIOD


//RS485_COM2接收使能
#define 			RS485_COM2_RxEnable(x)    						((x) ? (GPIO_ResetBits(RS485_COM2_EnGPIOX , RS485_COM2_EnPIN)) : (GPIO_SetBits(RS485_COM2_EnGPIOX , RS485_COM2_EnPIN)))
#define 			RS485_COM5_RxEnable(x)    						((x) ? (GPIO_ResetBits(RS485_COM5_EnGPIOX , RS485_COM5_EnPIN)) : (GPIO_SetBits(RS485_COM5_EnGPIOX , RS485_COM5_EnPIN)))
